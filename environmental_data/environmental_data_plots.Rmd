...
get max daily temp experienced for time points of coral monitoring
```{r}
#december 6 (initial)
#jan 26 (t1)
#april 4 (t2)
...
PAR_summary %>% 
  group_by(reef) %>% 
  summarise(mean_PAR_day = mean(PAR_mol_day))
...
bottlesampledata %>% 
  select(collected_date, collected_time, collected_site, calc_salinity) %>% 
